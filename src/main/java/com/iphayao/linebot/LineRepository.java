...
//		List<Map<String, Object>> result = null;
	...
	public ArrayList<Map<String, Object>> ThreeDay_Holiday_Soon(){
		...
		try {
			...
			stb.append("SELECT name_holiday, date_holiday FROM holiday WHERE to_date(date_holiday, 'dd/mm/yyyy') BETWEEN now() and to_date('31/12/2019', 'dd/mm/yyyy') ORDER BY to_date limit 3");
