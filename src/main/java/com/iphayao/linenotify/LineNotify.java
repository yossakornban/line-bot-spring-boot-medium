...
public class LineNotify {
    ...
    private LineNotifyParameter lineParameter;

    public LineNotify(String userToken) {
        this.userToken = userToken;
    }
    
    public LineNotify(String userToken, LineNotifyParameter lineParameter) {
        this.userToken = userToken;
    ...
    public boolean notifyMe(String message,int stickerPackageId,int stickerId) throws IOException{  
        if(this.lineParameter == null)
            this.lineParameter = new LineNotifyParameter(message, stickerPackageId, stickerId);
        int resStatus =  LineNotifyConnection.sendData(this.lineParameter,this.userToken);
